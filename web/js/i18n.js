...
(function (global) {
  ...
  var T = {
    zh: {
      ...
      'settings.tts.provider.openrouter': 'OpenRouter（真·TTS）',
      ...
      'settings.openrouterBaseHint': '留空=官方 OpenRouter（https://openrouter.ai/api/v1）。走 /audio/speech，与聊天用的 /chat/completions 是不同接口。',
      'settings.openrouterModelClone.hint': '支持声音克隆的模型 ID，官方文档点名 fish-audio/s2.1-pro。不是所有模型都支持克隆。',
      'settings.refAudio.hint': '必须是 wav 或 mp3；APK 里的原声是 m4a，需先转码。',
      'settings.openrouterModel': 'OpenRouter TTS 模型',
      'settings.openrouterModel.hint': '可手填任意模型 ID，如 openai/gpt-4o-mini-tts。模型目录常变，这里只是候选。',
      'settings.openrouterVoice': 'OpenRouter 音色',
      'settings.openrouterVoice.hint': '预设音色名，视模型而定（如 alloy/nova，或 microsoft 的 en-US-Harper:MAI-Voice-2）。',
    ...
    ja: {
      ...
      'settings.tts.provider.fish': 'Fish Audio',
      'settings.tts.provider.openrouter': 'OpenRouter（本物の TTS）',
      ...
      'settings.openrouterBaseHint': '空欄＝公式 OpenRouter（https://openrouter.ai/api/v1）。/audio/speech を使用。チャット用の /chat/completions とは別のエンドポイントです。',
      'settings.openrouterModelClone.hint': '声のクローンに対応したモデル ID。公式ドキュメントでは fish-audio/s2.1-pro が明記されています。全モデルが対応しているわけではありません。',
      'settings.refAudio.hint': 'wav か mp3 が必須です。APK 内の原音は m4a なので、事前に変換してください。',
      'settings.openrouterModel': 'OpenRouter TTS モデル',
      'settings.openrouterModel.hint': '任意のモデル ID を手入力できます（例: openai/gpt-4o-mini-tts）。モデル一覧は変わりやすいので候補のみです。',
      'settings.openrouterVoice': 'OpenRouter 音色',
      'settings.openrouterVoice.hint': 'プリセット音色名。モデルにより異なります（alloy/nova、あるいは microsoft の en-US-Harper:MAI-Voice-2 など）。',
    ...
    en: {
      ...
      'settings.tts.provider.fish': 'Fish Audio',
      'settings.tts.provider.openrouter': 'OpenRouter (real TTS)',
      ...
      'settings.openrouterBaseHint': 'Empty = official OpenRouter (https://openrouter.ai/api/v1). Uses /audio/speech \u2014 a different endpoint than /chat/completions used for chat.',
      'settings.openrouterModelClone.hint': 'A cloning-capable model id \u2014 OpenRouter\u2019s docs name fish-audio/s2.1-pro specifically. Not every model supports cloning.',
      'settings.refAudio.hint': 'Must be wav or mp3; the APK\u2019s original voice is m4a and needs transcoding first.',
      'settings.openrouterModel': 'OpenRouter TTS model',
      'settings.openrouterModel.hint': 'Type any model id, e.g. openai/gpt-4o-mini-tts. The catalog changes often \u2014 these are just suggestions.',
      'settings.openrouterVoice': 'OpenRouter voice',
      'settings.openrouterVoice.hint': 'Preset voice name, model-dependent (e.g. alloy/nova, or microsoft\u2019s en-US-Harper:MAI-Voice-2).',
