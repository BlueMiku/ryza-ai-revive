...
N.setEnabled(true);
ok(N.enabled() === true && N.active() === false, 'granting permission alone does not undress her');
N.onTurn({ nsfw: true });
ok(N.active() === true && sandbox.Avatar._calls.pop() === 'nsfw', 'llm can undress once permission is granted');
